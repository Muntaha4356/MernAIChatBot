      ...
      <div className="flex flex-wrap justify-center gap-8">
        {plans.map((plan)=>{
          ...
          transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id ==="pro" ? 
            ...
            <h3 className='text-xl font-semihold text-gray-900 dark:text-white mb-2'>
              {plan.name}</h3>
          ...
          <button onClick={() => purchasePlan(plan._id)} className='mt-6 bg-purple-600 hover:bg-purple-700
