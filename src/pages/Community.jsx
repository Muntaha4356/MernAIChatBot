...
const Community = () => {
  ...
  return (
    ...
    overflow-y-scroll'>
      ...
      {images.length > 0 ? (<div className='flex flex-wrap max-sm:justify-center gap-5'>
          {images.map((item, index)=>{
            return(<a href={item.imageUrl} target='_blank' key={index} className='relative group block rounded-lg overflow-hidden
      ...
      className='text-center text-gray-600 dark:text-purple-200 mt-10'>No Images Available</p>)}
